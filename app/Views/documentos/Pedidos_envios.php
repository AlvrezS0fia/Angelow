...
<div class="terms-container">
    ...
    <div class="terms-nav">
        ...
        <a href="#procesamiento" class="nav-link"><i class="fas fa-cogs"></i> Procesamiento</a>
        <a href="#envio" class="nav-link"><i class="fas fa-truck"></i> Envíos</a>
        <a href="#entrega" class="nav-link"><i class="fas fa-box"></i> Entrega</a>
        <a href="#incidencias" class="nav-link"><i class="fas fa-exclamation-triangle"></i> Incidencias</a>
    </div>
    ...
    <div class="terms-content">
        ...
        <div class="term-section" id="procesamiento">
            <h2><i class="fas fa-cogs"></i> 3. PROCESAMIENTO</h2>
        ...
        <div class="term-section" id="envio">
            <h2><i class="fas fa-truck"></i> 4. ENVÍOS</h2>
            <p>Los envíos se realizan a todo el territorio nacional mediante operadores logísticos autorizados.</p>
            <ul>
                <li><i class="fas fa-city"></i> Ciudades principales: 2 a 5 días hábiles.</li>
                <li><i class="fas fa-map-marker-alt"></i> Municipios y zonas apartadas: 5 a 10 días hábiles.</li>
            </ul>
        ...
        <div class="term-section" id="entrega">
            <h2><i class="fas fa-box"></i> 5. ENTREGA DEL PRODUCTO</h2>
        ...
        <div class="term-section" id="incidencias">
            <h2><i class="fas fa-exclamation-triangle"></i> 6. INCIDENCIAS Y RECLAMOS</h2>
...
<footer>
    ...
    <div class="footer-links">
        ...
        <a href="<?= APP_URL ?>/documentos/Politicas_devolucion"><i class="fas fa-undo"></i> Devoluciones y Cambios</a>
        <a href="<?= APP_URL ?>/documentos/Preguntas"><i class="fas fa-question-circle"></i> Preguntas Frecuentes</a>
        <a href="<?= APP_URL ?>/documentos/Guia_Tallas"><i class="fas fa-ruler"></i> Guía de Tallas</a>
